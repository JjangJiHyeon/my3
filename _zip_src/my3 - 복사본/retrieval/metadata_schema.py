...
INT_FIELDS = {"page_num", "chunk_index", "table_count", "image_count", "char_len", "token_estimate", "visual_index"}
FLOAT_FIELDS = {"visual_confidence"}
...
def normalize_metadata_record(
    ...
    for field in FLOAT_FIELDS:
        record[field] = _as_float(merged.get(field))
