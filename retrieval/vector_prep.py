...
def prepare_vectors(
    ...
    manifest = {
        ...
        "input_chunk_files": build_stats["input_chunk_files"],
    ...
    _json_dump(
        output_dir / "latest.json",
        {
            ...
            "metadata_path": str(run_dir / "chunk_metadata_records.jsonl"),
            "vectors_path": str(run_dir / "vectors.npz"),
            "id_map_path": str(run_dir / "id_map.json"),
        },
    )
